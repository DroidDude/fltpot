...
public class WingsUpgradeItem extends SmithingTemplateItem {
    ...
    private static final Component WINGS_UPGRADE_APPLIES_TO = Component.translatable(
                    Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "smithing_template.wings_upgrade.applies_to"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component WINGS_UPGRADE_INGREDIENTS = Component.translatable(
                    Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "smithing_template.wings_upgrade.ingredients"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component WINGS_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "smithing_template.wings_upgrade.base_slot_description"))
    );
    private static final Component WINGS_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "smithing_template.wings_upgrade.additions_slot_description"))
    );
    private static final Component WINGS_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "wings_upgrade")))
